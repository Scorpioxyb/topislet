...
当前版本为 **v0.1.2-alpha.3 开发候选版**，正在验证汽水音乐进度跳转、端到端控制确认、日常日志采集覆盖、单一音乐来源准入、安全媒体控制、Apple Music 与网易云音乐 Alpha 支持和顶部交互。它不是 Apple、汽水音乐或网易云音乐的官方产品，也暂不适合 App Store 分发。
